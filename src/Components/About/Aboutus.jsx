...
//     <>
//     {/* Left Side */}
//     <div className=' h-130 w-full flex px-40 mt-5'>
//       <div>
//         <img className='h-120 relative' src={ image1 } alt="" />
//         <div >
...
//       {/* Right side */}
//       <div className='px-10' >
//         <h1 className='text-[#0061E0] text-sm font-semibold mt-5 '>ABOUT US</h1>
//         <div className='h-20 w-130 mt-5'>
//           <h2 className='text-4xl font-bold '>We're on a Mission to Change View of RealEstate Field.</h2>
//         </div>
//         <div className='h-10 w-130 text-sm text-gray-500 mt-5'>
//           <p>Lorem ipsum dolor sit amet consectetur adipisicing elit ux sed eiusmod tempor
//                incididunt ut labore et dolore.enim admix minim veniam quis nostrud.</p>
//         </div>
//         {/* Right lower part */}
//         <div className='flex gap-10 mt-10'> 
//           <div className='h-50 w-65' >
//             <img src={ Villa } alt="Gallery" />
//             <h1 className='font-bold text-lg mt-3'>Modern Villa</h1>
//             <p className='text-gray-500 mt-3'>When unknown printer took galley of type and scrambled.</p>

//           <div className='flex text-[#0061E0] mt-4'>
...
//         <div className='h-50 w-65' >
//             <img src={ Money } alt="Gallery" />
//             <h1 className='font-bold text-lg mt-3'>Secure Payment</h1>
//             <p className='text-gray-500 mt-3'>When unknown printer took galley of type and scrambled.</p>
//           </div>
